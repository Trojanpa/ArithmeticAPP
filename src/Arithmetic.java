...
public class Arithmetic extends Application {
    private static long startDoTestTime = 0;                          //做题开始时间
    private static long endDoTestTime = 0;                            //做题结束时间
    private static long costTime = 0;                                 //计算考试花费时间
    private static String titleString = null;                         //存储题目
    private static int calculateResult;                               //四则运算计算结果
